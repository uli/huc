...
int main()
{
  ...
  if (ngeu(0, ~0/*U*/) !=  0) abort();
  if (ngeu(~0/*U*/, 0) != -1) abort();
  if (ngtu(0, ~0/*U*/) !=  0) abort();
  if (ngtu(~0/*U*/, 0) != -1) abort();
  if (nleu(0, ~0/*U*/) != -1) abort();
  if (nleu(~0/*U*/, 0) !=  0) abort();
  if (nltu(0, ~0/*U*/) != -1) abort();
  if (nltu(~0/*U*/, 0) !=  0) abort();
